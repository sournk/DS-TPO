...
- [x] `SLMode`: Режим SL *(0.1.1)*: 
    ...
    - `Ближайший экстремум BOS`: бот найдет ближайшую вершину справа от BOS и установит SL в это значение.
    - ==`Следующий после POC экстремум`: бот найдет следующую после POC вершину и установит SL в это значение.==
        > **ВАЖНО!!!**  
    ...
    - ==`Самый дальний экстремум между POC и BOS`: бот найдет экстремум между POС и BOS и установит SL в это значение.==
...
- [ ] 3. Добавить отмену ордеров. ==Могу сделать. Жду правила отмены.==
- [ ] 4. Дополнительная опция проверки SP для входов даже в режиме NPOC. ==К этой опции вернемся после сдачи основного функционала==.
...
## Замечания 17.07.24
- [ ] 4.8. Ограничить по времени входы в сделки дополнительно к поиску POC.
- [ ] 4.9. BOS определять по простому фракталу: hHh/lLl вместо ZZ.
- [ ] 4.10. Добавить 3-ий режим определения SL: экстремум между точкой входа и началом BOS.
- [ ] 4.11. Добавить фильтр входа в сделку, если SL превышает ATR в X раз.
- [ ] 4.12. Добавить фильтр входа в сделку, если расстояние от входа до NPOC превышает ATR в X раз.
- [ ] 4.13. Добавить 3-ий режим сдвига NPOC: на X границ блоков.