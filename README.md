...
- [x] 4. Бот классифицирует каждый POC как поддержку (SUP) или сопротивление (RES). Тип зависит от положения POC относительно цены открытия следующего дня. Если POC выше цены открытия, то POC определяется как SUP. Иначе - RES. 
