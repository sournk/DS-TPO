...
- [x] `Lot`: Лот ордера или позиции.
- [x] `SLDist`: Дистанция SL, пункт
- [x] `TPDist`: Дистанция TP, пункт
...
- [x] 1. Добавить сдвиг POC на фиксированную дистанцию, чтобы входить не от середины диапазона POC, а от границ. - 1h
- [ ] 2. Добавить режим динамического SL - за последний HIGH/LOW.
- [ ] 3. Добавить ограничение максимальной дистанции SL. При превышении не входить в сделки.
- [ ] 4. Добавить динамический расчет лота от SL и макс. % риска.
- [ ] 5. Добавить режимы TP: а) POC; б) VAL/VAH; в) Мультипликатор RR.
- [x] 6. **Отложено**: Заменить ZigZag на Fractals для поиска BOS.
- [x] 7. **Отложено**: Получать POC от FX CME через TV или другие платформы.

**Режим SP:**
- [ ] 1. Ошибочный вход в SELL от нижних SP 2024.04.17 08:57 EURUSD.
- [ ] 2. Добавить фильтр входов при пробои BOS, если SP уже неактуальны.
- [ ] 3. Добавить параметры сколько раз в день можно входить от SP.
