...
- [ ] 4.16. Добавить режим входа в сделку `Агресивный`. После пробития BOS на тике входить по рынку. 
- [ ] 4.17.а. Добавить режим входа в сделку `Консервативный`. После закрытия свечи выше/ниже BOS размещать отложенные ордера: а) STOP для цены ниже BOS; б) LIMIT для цены выше BOS. 
- [ ] 4.17.б. Убрать режим входа STOP ордером от POC. Входы будут только от BOS.
- [ ] 4.18. Добавить опциональный фильтр входа в сделки по наличию нужного количества SP профиля текущего дня.
